...
public class MpGenerator {
    ...
    String[] tableArray = {"v6_aio_data", "v6_aio_result"};
    String[] tablePrefixArray = {"t_"};
    String packageName = "com.cj";
    String moduleName = "saio";

    // TODO 数据源信息
    String url = "jdbc:mysql://47.103.64.182:63306/ujiev2?useUnicode=true&characterEncoding=utf8&zeroDateTimeBehavior=convertToNull&useSSL=false&serverTimezone=Asia/Shanghai";
//    String url = "jdbc:mysql://47.103.64.182:63306/ujiev2";
...
//                .enableKotlin() // 开启 kotlin 模式	默认值:false
                .dateType(DateType.SQL_PACK) // 时间策略	DateType.ONLY_DATE 默认值: DateType.TIME_PACK
...
//                .other("domain.dto") // 自定义文件包名	输出自定义文件时所用到的包名
        ...
        pathInfo.put(OutputFile.mapperXml, projectPath + "//resources//xml"); // 单独配置xml路径，可覆盖全局配置。
